...
(function() {
  ...
  if( width > "450") imgIllustration.data = "assets/images/illustration-sign-up-desktop.svg";
  else imgIllustration.data = "assets/images/illustration-sign-up-mobile.svg";
